// components/Navbar.tsx — Updated with Models nav link
'use client';

import { useState } from 'react';
import { BarChart2, Store, TrendingUp, Calendar, MapPin, Brain, Map, FlaskConical, Menu, X } from 'lucide-react';
...
const navItems = [
  ...
  { label:'ML Models',   href:'#models',      icon:<FlaskConical size={15} /> },
